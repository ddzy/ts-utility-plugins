...
(function (ColorfulBubble) {
    ...
    var bubbleArr = [];
    var mousePoint = {
        x: ColorfulBubble.yyg_settings.cvsWidth && ColorfulBubble.yyg_settings.cvsWidth * 2,
        y: ColorfulBubble.yyg_settings.cvsHeight && ColorfulBubble.yyg_settings.cvsHeight * 2,
    };
    ...
    (function (Init) {
        ...
        function initBubble() {
            var _a = ColorfulBubble.yyg_settings, bubbleNum = _a.bubbleNum, allowMouse = _a.allowMouse;
        ...
        function _moveByMouse() {
            var _a = ColorfulBubble.yyg_settings, cvsWidth = _a.cvsWidth, cvsHeight = _a.cvsHeight;
            ColorfulBubble.yyg_el.addEventListener('mousemove', function (e) {
                mousePoint.x = e.clientX;
                mousePoint.y = e.clientY;
            });
            ColorfulBubble.yyg_el.addEventListener('mouseleave', function () {
    ...
    var Bubble = /** @class */ (function () {
        ...
        Bubble.prototype.move = function () {
            var _a = ColorfulBubble.yyg_settings, cvsWidth = _a.cvsWidth, cvsHeight = _a.cvsHeight, bubbleExpandRange = _a.bubbleExpandRange;
            var centerPoint = this.centerPoint;
            var distance = this.distance;
            var radius = this.radius;
            // 鼠标 - 球中心 距离
            var mouseToBubbleDistanceX = Math
                .pow(centerPoint.x - mousePoint.x, 2);
            var mouseToBubbleDistanceY = Math
                .pow(centerPoint.y - mousePoint.y, 2);
            var mouseToBubbleDistance = Math
            ...
            else if (mouseToBubbleDistance > bubbleExpandRange
