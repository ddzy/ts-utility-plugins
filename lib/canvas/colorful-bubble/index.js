...
(function (ColorfulBubble) {
    ...
    (function (Init) {
        ...
        function initBubble() {
            ...
            window.setInterval(function () {
                ColorfulBubble.yyg_pen.clearRect(0, 0, ColorfulBubble.yyg_settings.cvsWidth, ColorfulBubble.yyg_settings.cvsHeight);
                a.move();
                a.draw();
            }, 1000 / 60);
        }
    ...
    var Bubble = /** @class */ (function () {
        function Bubble() {
            ...
            var bubbleSpeed = ColorfulBubble.yyg_settings.bubbleSpeed;
            this.centerPoint = {
