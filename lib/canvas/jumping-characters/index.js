...
(function (JumpingCharacters) {
    ...
    function _aidedTick() {
        ...
        timer = setInterval(function () {
            ...
            for (var _i = 0, saveCharactersArr_1 = saveCharactersArr; _i < saveCharactersArr_1.length; _i++) {
    ...
    var JC = /** @class */ (function () {
        ...
        JC.prototype.draw = function () {
            ...
            yyg_pen.fillText(text, centerPoint.x, centerPoint.y);
            yyg_pen.closePath();
            yyg_pen.restore();
        };
