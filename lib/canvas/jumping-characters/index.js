...
(function (JumpingCharacters) {
    ...
    function _aidedInitJC() {
        ...
        ele.addEventListener('click', function (e) {
            ...
            // new JC();
            var jc = new JC();
            JumpingCharacters.saveCharactersArr.push(jc);
        }, false);
    }
    var Utils;
    (function (Utils) {
    ...
    var JC = /** @class */ (function () {
        ...
        JC.prototype.draw = function () {
            var _a = this, text = _a.text, textColor = _a.textColor, textSize = _a.textSize, opacity = _a.opacity;
            JumpingCharacters.yyg_pen.save();
            JumpingCharacters.yyg_pen.beginPath();
            JumpingCharacters.yyg_pen.fillStyle = Utils.isArray(textColor)
            ...
            JumpingCharacters.yyg_pen.globalAlpha = opacity;
            JumpingCharacters.yyg_pen.fillText(Utils.isArray(text)
                ? text[Utils.getRandomWithPositive(0, text.length)]
                : text, JumpingCharacters.mousePoint.x, JumpingCharacters.mousePoint.y);
