    ...
    (function (Main) {
        var Scroll = /** @class */ (function () {
            ...
            Scroll.prototype.handleImgHover = function () {
                ...
                var oLeftArrow = this.oPrevArrow;
                var oRightArrow = this.oNextArrow;
                for (var key in oListItem) {
                    if (oListItem.hasOwnProperty(key)) {
                        var element = oListItem[key];
                        element.addEventListener('mouseenter', function () {
                            clearInterval(_this.timer);
                            Utils.addClass(oLeftArrow, 'yyg-prev-wrapper-active');
                            Utils.addClass(oRightArrow, 'yyg-next-wrapper-active');
                        }, false);
                        element.addEventListener('mouseleave', function () {
                            _this.handleAutoScroll();
                            Utils.removeClass(oLeftArrow, 'yyg-prev-wrapper-active');
                            Utils.removeClass(oRightArrow, 'yyg-next-wrapper-active');
                        }, false);
                    }
                }
            };
