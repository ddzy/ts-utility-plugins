...
(function (Carousel) {
    ...
    (function (Main) {
        ...
        var Fade = /** @class */ (function () {
             ...
             * 处理 自动轮播
             */
            Fade.prototype.handleAutoFade = function () {
                var _this = this;
                var oContentItem = this.oContentItem;
                var oDotsItem = this.oDotsItem;
                var oContentItemLength = this.oContentItemLength;
                var oDotsItemLength = this.oDotsItemLength;
                this.timer = setInterval(function () {
                    _this.count++;
                    Utils.setCss(oContentItem[_this.count], {
                    ...
                    Utils.addClass(oDotsItem[_this.count], 'yyg-dot-item-active');
                }, yyg_settings.delayTime);
                oContentItem.forEach(function (item) {
                    item && item.addEventListener('transitionend', function () {
                        _this.count = _this.count >= oContentItemLength - 1
                            ? -1
                            : _this.count;
                        Utils.setCss(item, {
                            opacity: 0,
