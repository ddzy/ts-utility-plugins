        ...
        var Scroll = /** @class */ (function () {
            ...
            Scroll.prototype.handleAutoScroll = function () {
                ...
                this.timer = setInterval(function () {
                    ...
                    _this.count === oItemLength
                        ? Utils.addClass(oDotsItem[0], 'yyg-dot-item-active')
                        : Utils.addClass(oDotsItem[_this.count - 1], 'yyg-dot-item-active');
            ...
            Scroll.prototype.handleDotsHover = function () {
                ...
                var oList = Utils
                    .getEle('.yyg-content-list');
                var oListWidth = oList
                    .offsetWidth;
                var oItemLength = yyg_settings
                    .dataSource
                    .length + 1;
                var oItemWidth = oListWidth / (oItemLength);
                var oDotsItem = document
