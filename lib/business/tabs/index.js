...
(function (Tabs) {
    ...
    var Tab = /** @class */ (function () {
        ...
        Tab.prototype.handleMouse = function () {
            var mouse = Tabs.defaultSettings.mouse, tabBarGap = Tabs.defaultSettings.tabBarGap, type = Tabs.defaultSettings.type, defaultActiveKey = Tabs.defaultSettings.defaultActiveKey, animated = Tabs.defaultSettings.animated, onTabClick = Tabs.defaultSettings.onTabClick, onChange = Tabs.defaultSettings.onChange;
            var paneList = Utils
            ...
            barItems.forEach(function (item, index) {
                item.addEventListener(mouse, function () {
                    ...
                    onChange && onChange(Utils.getAttr(item, 'data-id'));
